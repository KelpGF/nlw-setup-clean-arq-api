...
--execute="DROP DATABASE IF EXISTS $MYSQL_DATABASE; CREATE DATABASE $MYSQL_DATABASE; DROP DATABASE IF EXISTS $MYSQL_TESTS_DATABASE; CREATE DATABASE $MYSQL_TESTS_DATABASE;"
